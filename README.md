#  PCF Metrics Documentation Book 

This project can create and publish the documentation for PCF Metrics as a web application.
...
Here you'll find the configuration and templates for the PCF Metrics documentation set published to [docs.pivotal.io/pcf-metrics/](http://docs.pivotal.io/pcf-metrics/).
